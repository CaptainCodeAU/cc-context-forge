...
```bash
# 1. Copy latest release to your project
cp -r Releases/v1.0/* your-project/.prompts/
...
- `Releases/v1.0` is frozen as immutable release content.
- Verify prompt file checksums against [`RELEASE_MANIFEST.md`](RELEASE_MANIFEST.md) when needed.
- Place prompts in the consuming project's `.prompts/` directory and keep that directory gitignored.
